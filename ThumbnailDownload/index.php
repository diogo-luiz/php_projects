...
<body>
    <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
        ...
        <div class="url-input">
            ...
            <div class="field">
                <input type="text" placeholder="https://www.youtube.com/watch?v=FucPPCPDd2Y&list=PLpwngcHZlPaf1aw42OGyitm4jh2Dlmi9c&index=3" required>
        ...
        <button class="download-button" name="download" type="submit">Download Thumbnail</button>
    ...
    <script>
        ...
        urlField.onkeyup = ()=>{
            ...
            if(imgUrl.indexOf("https://www.youtube.com/watch?v=") != -1){
                ...
                let ytThumbUrl = 'https://img.youtube.com/vi/'+ vidId +'/maxresdefault.jpg';
                imgTag.src = ytThumbUrl;
            }else if(imgUrl.match(/\.(jpg|jpeg|png|gif|bmp|webp)$/i)){
                imgTag.src = imgUrl;
